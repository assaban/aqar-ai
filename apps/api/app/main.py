...
from apps.api.app.routers import admin, agents, health, pipeline, properties, search, videos
...
def create_app() -> FastAPI:
    ...
    app.include_router(agents.router, prefix="/api/v1", tags=["Agents & Channels"])
